...
namespace NapierHolidayVillage
{
     ...
     * DECORATOR PATTERN - This extra extends booking functionality simply by adding meal's cost to the basic cost and dietary requirements of the meal
     *
    ...
    /// </summary>
    [Serializable]
    class EveningMeal_Decorator : Extras_Decorator
    {
        ...
        ////constructor
        public EveningMeal_Decorator(Booking booking_component)
        ...
        {
            return (15 * booking_component.Guests.Count * booking_component.DaysBooking);
        }
    }
}
